...
DXL_MINIMUM_POSITION_VALUE  = 98               # Dynamixel will rotate between this value
DXL_MAXIMUM_POSITION_VALUE  = 862            # and this value (note that the Dynamixel would not move when the position value is out of movable range. Check e-manual about the range of the Dynamixel you use.)
